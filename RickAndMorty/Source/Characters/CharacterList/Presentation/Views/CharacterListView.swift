...
struct CharacterListView: View {
    ...
    var body: some View {
        ...
        .task { await viewModel.loadInitialCharacters() }
        .refreshable { await viewModel.loadInitialCharacters() }
        .navigationTitle(L10n.Common.characters)
        .navigationBarTitleDisplayMode(.inline)
        .alert(L10n.Errors.alertTitle, isPresented: $viewModel.showError) {
